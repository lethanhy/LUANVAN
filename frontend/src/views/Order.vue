    ...
    <div class="row">
      <form class="d-flex flex-wrap">
        ...
        <div class="col-lg-8 bg-white p-4 shadow rounded-3 mb-4">
          ...
          <div class="d-flex align-items-start mb-4 border border-secondary rounded-3 p-3">
            ...
            <div class="col-lg-9 ms-3 text-start">
              <p class="mb-1 fw-bold fs-5">Phòng 102</p>
              <p class="mb-1 text-muted"><i class="fas fa-user"></i> 2 khách</p>
              <p class="mb-1 text-success">500.000 VND/Đêm</p>
          ...
          <h2 class="mt-4 text-info">Nhập thông tin cá nhân</h2>
          <div class="text-start mt-3">
            <div class="row g-3">
              <div class="col-md-6">
                <label for="name" class="form-label">Tên</label>
                <input type="text" class="form-control rounded-3" id="name" placeholder="Nguyễn Văn A">
              </div>
              <div class="col-md-6">
                <label for="address" class="form-label">Địa chỉ</label>
                <input type="text" class="form-control rounded-3" id="address" placeholder="Cần Thơ">
              </div>
            </div>
            <div class="row g-3 mt-3">
              <div class="col-md-6">
                <label for="email" class="form-label">Email</label>
                <input type="email" class="form-control rounded-3" id="email" placeholder="email@example.com">
              </div>
              <div class="col-md-6">
                <label for="phone" class="form-label">Số điện thoại</label>
                <input type="tel" class="form-control rounded-3" id="phone" placeholder="0123 456 789">
              </div>
            </div>
            <div class="row g-3 mt-3">
              <div class="col-md-6">
                <label for="cccd" class="form-label">Căn cước công dân</label>
                <input type="text" class="form-control rounded-3" id="cccd" placeholder="098765432123">
              </div>
              <div class="col-md-6">
