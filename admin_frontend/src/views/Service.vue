<template>
    <div class="roomManager">
        <div class="roomManager--body">
            <h1 class="text-center text-info fw-bold">Quản lý dịch vụ</h1>
                ...
                <div class="modal-content">
                    ...
                    <form @submit.prevent="addMenu">
                        <div class="mb-3">
                            ...
                            <input type="text" id="name" v-model="newMenu.name" class="form-control" required>
                        </div>
                        <div class="mb-3">
                            <label for="quantity" class="form-label">Số lượng</label>
                            <input type="text" id="quantity" v-model="newMenu.quantity" class="form-control" required>
                        </div>
                       
                        <div class="mb-3">
                            <label for="price" class="form-label">Giá sản phẩm</label>
                            <input type="text" id="price" v-model="newMenu.price" class="form-control" required>
                        </div>
